...
echo -e "${MAGENTA} ___/\\\//////////____/\\\/////////\\\_\/\\\_______\/\\\_       ${NC}"
echo -e "${MAGENTA}  __/\\\______________\//\\\______\///__\/\\\_______\/\\\_      ${NC}"
echo -e "${MAGENTA}   _\/\\\____/\\\\\\\___\////\\\_________\/\\\\\\\\\\\\\\\_     ${NC}"
echo -e "${MAGENTA}    _\/\\\___\/////\\\______\////\\\______\/\\\/////////\\\_    ${NC}"
echo -e "${MAGENTA}     _\/\\\_______\/\\\_________\////\\\___\/\\\_______\/\\\_   ${NC}"
echo -e "${MAGENTA}      _\/\\\_______\/\\\__/\\\______\//\\\__\/\\\_______\/\\\_  ${NC}"
echo -e "${MAGENTA}       _\//\\\\\\\\\\\\/__\///\\\\\\\\\\\/___\/\\\_______\/\\\_ ${NC}"
echo -e "${MAGENTA}        __\////////////______\///////////_____\///________\///__${NC}"
