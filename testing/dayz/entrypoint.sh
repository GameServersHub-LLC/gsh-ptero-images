...
echo -e "${WHITE}( _____ )${YELLOW}For need support, join our discord at: discord.gg/gsh   ${WHITE}( _____ )${NC}"
echo -e "${WHITE} |     | ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~|     | ${NC}"
echo -e "${WHITE} |     |                                                                   |     | ${NC}"
...
echo -e "${WHITE} |     | ${RED} ░▓${WHITE}█▄   ▌${RED}░${WHITE}██▄▄▄▄██  ${RED}░ ${WHITE}▐██${RED}▓░     ${WHITE}▄▀${RED}▒   ░   ▒▓${WHITE}█  ▄ ${RED}░▓${WHITE}█  ██${RED}▓░▓${WHITE}█  ██${RED}▓ ${WHITE}|     | ${NC}"
echo -e "${WHITE} |     | ${RED} ░▒${WHITE}████${RED}▓  ▓${WHITE}█   ${RED}▓${WHITE}██${RED}▒ ░ ${WHITE}██${RED}▒▓░   ▒${WHITE}███████${RED}▒   ░▒${WHITE}████${RED}▒░▒▓${WHITE}███▀${RED}▒░▒▓${WHITE}███▀${RED}▒ ${WHITE}|     | ${NC}"
echo -e "${WHITE} |     | ${RED}  ▒▒▓  ▒  ▒▒   ▓▒${WHITE}█${RED}░  ${WHITE}██${RED}▒▒▒    ░▒▒ ▓░▒░▒   ░░ ▒░ ░ ░▒   ▒  ░▒   ▒  ${WHITE}|     | ${NC}"
