...
echo -e "${WHITE}( ___ )${WHITE} For need support, join our discord at: ${BLUE}discord.gg/gsh            ${WHITE}    ( ___ )${NC}"
echo -e "${WHITE} |   |~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~|   | ${NC}"
...
echo -e "${WHITE}(_____)${BRIGHT_WHITE}                    🎮  SERVER STARTING UP... 🎮                      ${WHITE}(_____)${NC}"
